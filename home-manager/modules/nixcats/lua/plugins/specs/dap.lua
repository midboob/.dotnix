...
vim.keymap.set('n', '<leader>B', function() dap.set_breakpoint(vim.fn.input('Breakpoint: ')) end, { desc = 'Debug: Set Breakpoint' })
...
if opts.virt_text_pos == 'inline' then return ' = ' .. variable.value end
return variable.name .. ' = ' .. variable.value
end,
virt_text_pos = (vim.fn.has('nvim-0.10') == 1) and 'inline' or 'eol',
all_frames = false, virt_lines = false, virt_text_win_col = nil,
})
end,
},
...
on_plugin = { 'nvim-dap' },
after = function() require('dap-go').setup() end,
},
}
